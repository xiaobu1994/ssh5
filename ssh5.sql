...
Source Database       : ssh5

Target Server Type    : MYSQL
Target Server Version : 50626
File Encoding         : 65001

Date: 2019-01-17 15:14:27
*/
...
-- Records of tb_user
-- ----------------------------
INSERT INTO `tb_user` VALUES ('1', '成都', '2017-01-09 17:26:39', '2017-01-09 17:26:41', '0', '超级管理员', 'whoismy8023@163.com', '0', 'admin', 'f4d478c1f6c7551a9890ad77b2bac932', '1', '15923930000', '2017-01-09 17:27:11', 'admin');
...
CREATE TABLE `test_book` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `author` varchar(252) DEFAULT NULL COMMENT '作者',
  `name` varchar(50) DEFAULT NULL COMMENT '名称',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
-- ----------------------------
-- Table structure for test_file_upload
-- ----------------------------
DROP TABLE IF EXISTS `test_file_upload`;
CREATE TABLE `test_file_upload` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `create_time` varchar(255) DEFAULT NULL,
  `name` varchar(255) DEFAULT NULL,
  `path` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `UK_nhs7o99u03h0vm2t8iy02es52` (`name`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of test_file_upload
-- ----------------------------
